...
type CombinedState = { generatedAt: string; opinionWeight: number; isAdmin: boolean; mainSnapshot: null | { id: number; baselineId: number; baselineCreatedAt: string; requested: boolean; createdAt: string; completedMatchCount: number; mode: string; opinionWeight: number }; modelComparison: null | { rootId: number; static: ModelScore; adaptive: ModelScore; selected: "static" | "adaptive"; reason: string }; series: SeriesRow[]; maps: MapRow[]; betLocks: BetLock[]; bracket: { qualifiers: string[]; nodes: BracketNode[]; champion: string | null }; live: { error: string | null } };
